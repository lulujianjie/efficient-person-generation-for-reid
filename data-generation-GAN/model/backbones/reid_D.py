...
class ReidDiscriminator(nn.Module):
    def __init__(self, cfg):
        super(ReidDiscriminator, self).__init__()
        neck = cfg.MODEL.MODEL_NECK  # If train with BNNeck, options: 'bnneck' or 'no'
        neck_feat = cfg.MODEL.NECK_FEAT
        ## Which feature of BNNeck to be used for test, before or after BNNneck, options: 'before' or 'after'
        self.in_planes = 2048
        self.base = ResNet50(last_stride=1,
                           block=Bottleneck,
                           layers=[3, 4, 6, 3])
        ...
        if self.neck == 'no':
            ...
            #self.bottleneck.bias.requires_grad_(False)  # no shift == affine = False
