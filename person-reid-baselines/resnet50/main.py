...
if __name__ == '__main__':
	...
	parser.add_argument('--market_path', type=str, default='/xxx/Market-1501-v15.09.15')
	...
	# model configuration
	parser.add_argument('--pid_num', type=int, default=702, help='751 for Market-1501, 702 for DukeMTMC-reID')
	...
	# test configuration
	parser.add_argument('--resume_test_epoch', type=int, default=-1, help='-1 for no resuming')

	# visualization configuration
	parser.add_argument('--resume_visualize_epoch', type=int, default=-1, help='-1 for no resuming')
