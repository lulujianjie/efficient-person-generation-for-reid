...
class Model(nn.Module):
    ...
    def __init__(self, class_num):
        ...
        resnet.load_state_dict(torch.load('/nfs-data/lujj/pretrained_model/resnet50-19c8e357.pth'))
        ...
        #         # vgg.load_state_dict(torch.load('/nfs-data/lujj/pretrained_model/vgg19-dcbb9e9d.pth'))
    ...
    def forward(self, x):
        ...
        features = self.gap(self.backbone(x)).squeeze()
